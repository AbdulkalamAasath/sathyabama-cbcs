...
const StudentTable = ({ course }) => {
    ...
    const handleRegister = async (e) => {
        e.preventDefault();
        const response = await fetch(`https://sathyabama-cbcs-backend1.vercel.app/cbcs/course/update/${courseInfo._id}`, {
            method: 'PUT',
        ...
        const response1 = await fetch(`https://sathyabama-cbcs-backend1.vercel.app/cbcs/course/update/user/${user.user_id}`, {
            method: 'PUT',

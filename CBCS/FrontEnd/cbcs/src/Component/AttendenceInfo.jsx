...
const AttendenceInfo = () => {
  ...
  const handleclick = async (value) => {
    ...
    const response = await fetch('https://sathyabama-cbcs-backend1.vercel.app/cbcs/staf/Attendence/Info', {
      method: 'POST',
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const response = await fetch('https://sathyabama-cbcs-backend1.vercel.app/cbcs/staf/Attendence/Date', {
        method: 'POST',
